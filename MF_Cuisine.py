...
#        print ('RMSE ', math.sqrt(e / count))
    ...
    pickle.dump(P, open("../Experiments/MF/P/"+str(E)+"_P60k_k"+str(K)+"_alpha"+str(alpha)+"_beta"+str(beta)+"_first_90train", "wb"))
    pickle.dump(Q, open("../Experiments/MF/Q/"+str(E)+"_Q60k_k"+str(K)+"_alpha"+str(alpha)+"_beta"+str(beta)+"_first_90train", "wb"))
...
if __name__ == "__main__":
    ...
    for K in range(5, 51, 5):
        ...
        for E in range(1, 11, 1):
            ...
            alpha = 0.01
            beta = 0.001
            nP, nQ = matrix_factorization(train_data_matrix, P, Q, K, E, steps, alpha, beta)
            nR = numpy.dot(nP, nQ)
            """
...
"""
    ...
    evaluation.to_csv("../Experiments/MF/Results/MF_Evaluation_" + str(K) + "_alpha" + str(alpha) + "_beta" + str(
