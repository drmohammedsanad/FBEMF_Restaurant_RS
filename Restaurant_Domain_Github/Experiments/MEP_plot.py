...
for i in range(1,len(MF_Evaluation_df['MEP'])):
    a.append(float(MF_Evaluation_df['MEP'][i]))

for i in range(1,len(MF_Evaluation_df['K'])):
    k.append(float(MF_Evaluation_df['K'][i]))

for i in range(1,len(EMF_Evaluation_df['MEP'])):
    b.append(float(EMF_Evaluation_df['MEP'][i]))

for i in range(1,len(FBEMF_Evaluation_df['MEP'])):
    c.append(float(FBEMF_Evaluation_df['MEP'][i]))
