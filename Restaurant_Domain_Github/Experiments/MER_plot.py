...
for i in range(1,len(MF_Evaluation_df['MER'])):
    a.append(float(MF_Evaluation_df['MER'][i]))

for i in range(1,len(MF_Evaluation_df['K'])):
    k.append(float(MF_Evaluation_df['K'][i]))

for i in range(1,len(EMF_Evaluation_df['MER'])):
    b.append(float(EMF_Evaluation_df['MER'][i]))

for i in range(1,len(FBEMF_Evaluation_df['MER'])):
    c.append(float(FBEMF_Evaluation_df['MER'][i]))
